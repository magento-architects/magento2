...
use Magento\Framework\Component\ComponentInstaller;

class ComponentInstallerTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testSortPackagesSortsByDependenciesOfSameType()
    {
        $sortedList = ComponentInstaller::sortPackages($packageDependencies);
